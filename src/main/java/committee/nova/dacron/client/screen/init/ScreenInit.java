...
public class ScreenInit {
    public static void init() {
        ScreenProviderRegistry.INSTANCE.registerFactory(SMITHING_CONTAINER, (syncId, id, player, buf) -> new SmithingScreen(new SmithingContainer(syncId, player.inventory, BlockContext.create(player.world, buf.readBlockPos())), player.inventory, new TranslatableText("gui.dacron.smithing.title")));
    }
}
